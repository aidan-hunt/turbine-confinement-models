...
- Hunt et. al., ["Performance characteristics and bluff-body modeling of high-blockage cross-flow turbine arrays with varying rotor geometry"](https://doi.org/10.1063/5.0272110), 2025, *Journal of Renewable and Sustainable Energy*. [Open-Access PDF on arXiv](https://doi.org/10.48550/arXiv.2410.19165).
